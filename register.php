...
$sql = "INSERT INTO register(customerName, customerPhone, email, password)"
        . " VALUES('$_POST[customerName]','$_POST[customerPhone]','$_POST[email]', '$_POST[password]')";
